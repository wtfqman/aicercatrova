...
4. Отправляет расшифровку в AI и получает компактный русский разбор: краткий смысл, нормальный перевод и 3-5 идей для контента.
5. Если расшифровка слабая, бот сокращает анализ и не выдумывает выводы.
6. CTA, план поста, хуки и заголовки добавляются только если пользователь попросил их прямо.
7. Возвращает результат в Telegram.
